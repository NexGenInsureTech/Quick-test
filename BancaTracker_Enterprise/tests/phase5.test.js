...
const allPartial = result("ALL", "ALL");
assert.strictEqual(allPartial.elapsed, 4);
assert.strictEqual(allPartial.remainingMonths, 8);
assert.ok(allPartial.rrrLabel.includes("/month"));
