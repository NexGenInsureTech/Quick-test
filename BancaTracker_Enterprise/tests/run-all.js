...
const groups = ["phase5.test.js", "phase6.test.js", "step81a.test.js", "step81b.test.js", "step81c.test.js", "step81d.test.js", "step81e.test.js", "step2j-reconciliation.test.js"];
let failed = false;
groups.forEach((file) => {
