...
const load = (file) => require(path.join(__dirname, "..", file)); load("js/config.js"); load("js/csvProcessor.js"); load("js/utilities.js"); load("js/analytics.js"); load("js/core.js"); load("js/performance.js"); load("app.js"); load("js/activation.js"); load("js/scorecard.js"); load("js/target.js");
...
BancaTrackerCore.state.filters.month = "ALL"; BancaTrackerCore.refresh(); assert.ok(!elements.zoneActivation.innerHTML.includes("<script>alert(1)</script>")); assert.ok(elements.zoneActivation.innerHTML.includes("&lt;script&gt;"));
