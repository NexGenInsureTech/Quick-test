(function (global) {
  ...
  const CATALOG = Object.freeze([
    ...
    e("activation", "Activation", "Activation & Opportunity", "Current-period active branches measured against the applicable Eligible Branch Universe denominator.", { pageRefs: ["Activation Cockpit", "Management Scorecard"], relatedTerms: ["Eligible Branch Universe", "Observed Branch"] }),
    ...
    e("observed-branch", "Observed Branch", "Activation & Opportunity", "A producing branch represented by accepted PR/business activity in the applicable scope; observation does not by itself establish denominator eligibility.", { relatedTerms: ["Eligible Branch Universe"] }),
    e("branch-universe", "Eligible Branch Universe", "Activation & Opportunity", "Branches eligible to participate in the Activation denominator for the selected period. An eligible branch can be included even without an accepted PR transaction in that period. Where governed effective-date evidence exists, historical eligibility reflects the selected period rather than today's Branch footprint.", { pageRefs: ["Activation Cockpit", "Productivity & Opportunity"], relatedTerms: ["Activation", "Observed Branch"] }),
    ...
    e("projected-shortfall", "Projected Shortfall", "Execution & Priority", "The expected remaining gap to Budget when the current month-end projection is below Budget; it is used where applicable in Execution Priority.", { pageRefs: ["Commercial Performance"], relatedTerms: ["Projected Month-end Actual", "Commercial Budget / Budget"] }),
    e("pace-gap-magnitude", "Pace Gap Magnitude", "Execution & Priority", "The size of the shortfall between current execution pace and the required governed pace, where the pace comparison is available.", { pageRefs: ["Commercial Performance"], relatedTerms: ["Pace", "Required Daily Run Rate"] }),
    ...
    e("target", "Target", "Target & Growth", "A configured annual management objective used by Target & Growth. It is distinct from Commercial Budget and Potential, and Target Seasonality affects only its monthly and YTD allocation.", { formula: "Target Seasonality allocates an annual Target across 12 fiscal months. A Bank's applicable Bank Seasonality is used for that Bank; otherwise it may inherit governed Overall Seasonality. Equal 12-month allocation is the fallback only when no applicable governed seasonality exists. The selected month receives its full governed monthly allocation even when partly elapsed; there is no daily Target proration. YTD Target is the cumulative applicable monthly allocation from the fiscal-year start through the selected month. RRR is the average business required across remaining fiscal months to close the remaining annual Target gap; it is not itself seasonally allocated or the next month's seasonal Target.", pageRefs: ["Target & Growth"], relatedTerms: ["Commercial Budget / Budget", "Potential"] }),
    e("potential", "Potential", "Target & Growth", "A governed estimate of addressable branch opportunity; it is neither Target nor a substitute for missing Budget. Target Seasonality does not redistribute Potential.", { pageRefs: ["Commercial Performance", "Target & Growth"] }),
    e("achievement", "Achievement", "Target & Growth", "Achievement compares Actual with the applicable Target or Budget for the view.", { formula: "Actual ÷ applicable Target or Budget × 100, when the denominator is positive", unit: "Percent", pageRefs: ["Commercial Performance", "Target & Growth"] }),
  ...
  function renderStaticContent() {
    ...
    [
      ...
      ["Activation Cockpit", "Answers how many branches are Active, Near Active, or Zero in the current global scope.", "Use global Month/Bank controls; review activation and opportunity. Activation uses the eligible denominator for the selected period, while observed branches are those with accepted activity. Inactive does not always mean Zero."],
      ...
      ["Target & Growth", "Answers progress against configured annual Target in the current global scope.", "Configure annual targets where required. Monthly and YTD Target follow applicable Target Seasonality; equal months are fallback only. Target is not Commercial Budget or Potential; ₹ Cr inputs retain their governed precision."],
