(function (global) {
  ...
  const CATALOG = Object.freeze([
    ...
    e("target", "Target", "Target & Growth", "A configured goal used by Target & Growth; it is distinct from governed Budget and Potential.", { formula: "Monthly Target phasing follows applicable governed seasonality; when no applicable governed seasonality exists, Target is allocated equally across 12 months.", pageRefs: ["Target & Growth"] }),
