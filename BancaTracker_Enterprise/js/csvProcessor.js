...
(function (scope) {
  ...
  function process(text, config, onProgress) {
    ...
    const rows = []; const rejectionReasons = {}; const warningReasons = {}; let warningRows = 0;
    ...
    return { rows, headerMap: map, summary: { totalRows, acceptedRows: rows.length, rejectedRows: totalRows - rows.length, warningRows, rejectionReasons, warningReasons } };
  }
